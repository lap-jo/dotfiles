...
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -lpng16 -lm -lm -lz -lm -lz -lbrotlicommon -lglib-2.0 -lm -lfreetype -lgraphite2 -lbz2 -lpng16 -lm -lm -lbrotlidec -lsysprof-capture-4 -pthread -lpcre2-8 -lz -lharfbuzz -lm -lbrotlidec -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 26.1.20
